...
function Container({data}) {
  ...
  return (<div className=" border-conversation-border w-full border-l bg-conversation-panel-background flex flex-col h-[100vh] overflow-hidden items-center justify-center text-white">
