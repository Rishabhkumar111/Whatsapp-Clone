...
function MessageBar() {
  ...
  const photoPickerChange = async(e)=>{
    try {
      ...
      const response = await axios.post(ADD_IMAGE_MESSAGES_ROUTE, fromData,{
        headers:{
  ...
  return (
    <div className="flex bg-panel-header-background h-20 px-4 items-center gap-6 relative">
      {
        !showAudioRecorder && (
        <>
          ...
          <div className="w-full rounded-lg h-16 flex items-center">
            <input type="text" placeholder="Type a message" className=" bg-input-background 
            text-sm focus:outline-none text-white h-10 rounded-lg px-5 py-4 w-full"
