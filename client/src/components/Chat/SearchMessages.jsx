  ...
  return <div className=" border-conversation-border border-1 w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
    ...
    <div className="h-full overflow-auto custom-scrollbar">
      ...
      <div className="flex justify-center h-full flex-col">
        {
          searchTerm.length && !searchedMessages.length && <span className=" text-secondary w-full justify-center flex">
            No messages found
          </span>
        }
        <div className="flex flex-col w-full h-full">
          {searchedMessages.map((message)=> <div className=" justify-center flex cursor-pointer flex-col hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary py-5">
